...
import com.edu.postest.modules.network.body.OnProgressListener
import com.edu.postest.modules.network.interceptor.LogInterceptor
import com.edu.postest.modules.network.interceptor.ProgressInterceptor
...
//        map.put("tag", RequestBody.create("text/plain".toMediaTypeOrNull(), "SD3123123"));
            ...
            client(listener).newCall(request).enqueue(object : OkCallback<Any>() {
