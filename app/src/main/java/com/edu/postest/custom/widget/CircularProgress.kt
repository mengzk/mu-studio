package com.edu.postest.custom.widget
...
class CircularProgress @JvmOverloads constructor(
    ...
    private var progressColor = ContextCompat.getColor(context, R.color.white)
    private var backgroundColor = ContextCompat.getColor(context, R.color.black)
